function myfunctionload() {
  document.body.style.background = "url('field.png')no-repeat fixed";
...
function myFunctionmarkt() {
  document.body.style.background = "url('field2.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionwoonwijken() {
  document.body.style.background = "url('field3.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM1(){
  document.body.style.background = "url('fieldM1.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM2(){
  document.body.style.background = "url('fieldM2.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM3(){
  document.body.style.background = "url('fieldM3.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM4(){
  document.body.style.background = "url('fieldM4.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM5(){
  document.body.style.background = "url('fieldM5.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM6(){
  document.body.style.background = "url('fieldM6.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM7(){
  document.body.style.background = "url('fieldM7.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM8(){
  document.body.style.background = "url('fieldM8.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM9(){
  document.body.style.background = "url('fieldM9.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";

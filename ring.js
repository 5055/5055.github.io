function myfunctionload() {
  document.body.style.background = "url('ring.png')no-repeat fixed";
...
function myFunctionmarkt() {
  document.body.style.background = "url('ring2.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionwoonwijken() {
  document.body.style.background = "url('ring3.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM1(){
  document.body.style.background = "url('ringM1.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM2(){
  document.body.style.background = "url('ringM2.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM3(){
  document.body.style.background = "url('ringM3.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM4(){
  document.body.style.background = "url('ringM4.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM5(){
  document.body.style.background = "url('ringM5.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM6(){
  document.body.style.background = "url('ringM6.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM7(){
  document.body.style.background = "url('ringM7.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM8(){
  document.body.style.background = "url('ringM8.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function myFunctionM9(){
  document.body.style.background = "url('ringM9.png')no-repeat fixed";
  document.body.style.backgroundSize = "100% 100%";
...
function othername() {
    ...
    if (input =="xc"){
      document.body.style.background = "url('ringM78.png')no-repeat fixed";
      document.body.style.backgroundSize = "100% 100%";
